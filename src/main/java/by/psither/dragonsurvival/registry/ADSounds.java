...
public class ADSounds {
	public static final DeferredRegister<SoundEvent> REGISTRY = DeferredRegister.create(Registries.SOUND_EVENT, AdditionalDragonsMod.MODID);
	...
	private static SoundEvent register(String name){
		...
		REGISTRY.register(name, ()->soundEvent);
		return soundEvent;
	}
}
